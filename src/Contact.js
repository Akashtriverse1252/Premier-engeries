            ...
            <div className="web-container">
              ...
              <div className="contactbox ">
                ...
                <div className="address ">
                    ...
                    <p>
                      <strong>Corporate Office</strong> 8<sup>th</sup> floor, Orbit Tower 1, Sy. No. 83/1, Hyderabad Knowledge City, TSIIC, Raidurgam, Hyderabad- 500081, Telangana, India.
                    </p>
                  ...
                  <div className="address">
                    ...
                    <p>
                      5<sup>th</sup> Floor, Southern Park, D-ll, Saket Place, 110017, New
                      Delhi, India{" "}
                    </p>
                  </div>
                  <div className="address">
                    <h4>PEGPL - Premier Energies Global Environment Private Limited</h4>
                    <p>8<sup>th</sup> floor, Orbit Tower 1, Sy. No. 83/1, Hyderabad Knowledge City, TSIIC, Raidurgam, Hyderabad- 500081, Telangana, India.</p>
                  </div>
                </div>
                <div className="premierenergies justify-content-start   ">
                <h3>North America</h3>
        ...
        <div className="grievance">
          <div className="container">
            <div className="web-container">
              ...
              <div className="grievancestrip">
                ...
                <div className="grievancebox">
                  <h3
                    ...
                    className={grievanceform ? "hemburgur" : "hemburgur active"}
                  >
                    Fill the form
                  </h3>
                </div>
              ...
              <div
                className={
                  grievanceform ? "grievanceform" : "grievanceform active"
                }
              >
                <form>
                  <div className="formstn">
                    <div className="firstrow">
                      ...
                      <ul>
                        <li>
                          <span>Date of Grievant</span>
                          <input type="date" />
                        </li>
                        <li>
                          <span>Grievant Name</span>
                          <input type="text" />
                        </li>
                        <li>
                          <span>Gender</span>
                        ...
                        <li>
                          <span>Name of village/area</span>
                          <input type="text" />
                        </li>
                        <li>
                          <span>Subject of the issue</span>
                          <input type="text" />
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="firstrow">
                      ...
                      <ul>
                        ...
                        <li>
                          <span>why is this a grivevence?</span>
                          <input type="text" />
                        </li>
                        <li>
                          <span>what adjustment is required?</span>
                          <input type="text" />
                        </li>
