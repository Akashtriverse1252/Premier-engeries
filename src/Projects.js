...
export const Projects = () => {
  return (
    ...
    <meta name="description" content="Premier Energies is taking a stride towards supporting India's sustainability objectives by undertaking one of the largest solar EPC projects in Bangladesh from Rural Power Company Ltd." />
    <link rel="canonical" href="https://premierenergies.com/our-projects" />
    <meta property="og:url" content="https://premierenergies.com/our-projects" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Utility Scale EPC Projects in India By Premier Energies" />
    <meta name="og:description" content="Premier Energies is taking a stride towards supporting India's sustainability objectives by undertaking one of the largest solar EPC projects in Bangladesh from Rural Power Company Ltd.">
    </meta>
    </Helmet>
        <Header />
...
<div className='smallcirclerightdark'></div>
            ...
            <div className='row'>
                ...
                <div className='title centerheading'>
                  ...
                  <span className='colorborder'><em></em></span>
                    <h1 data-aos="fade-down" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">Our projects</h1>
                  </div>
                  </div>
                ...
                <div className='projectsimg'>
                    ...
                    <div className='projectbox'>
                        ...
                        <div className="projecttitle">
                            <div className="projleft">
                            <h4>70 kW AC</h4>
                            <p>THE AHILYA FORT HERITAGE HOTEL, MAHESHWAR, MADHYA PRADESH</p>
                            </div>
                            <div className='projright'>
                                {/* <h4>2016</h4> */}
                            </div>
