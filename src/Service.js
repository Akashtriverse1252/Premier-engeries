...
export const Service = () => {
  return (
    <>
    <Helmet>
    <title>PV Solar Products Manufacturer, India's Leading Solar Panel Supplier</title>
    <meta name="description" content="Premier Energies provides end-to-end solar services and solutions to a diversified international utility, commercial and residential roof-top, EPC projects to all over the world." />
    <link rel="canonical" href="https://premierenergies.com/our-services" />
    <meta property="og:url" content="https://premierenergies.com/our-services" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="PV Solar Products Manufacturer, India's Leading Solar Panel Supplier" />
    <meta name="og:description" content="Premier Energies provides end-to-end solar services and solutions to a diversified international utility, commercial and residential roof-top, EPC projects to all over the world.">
    </meta>
    </Helmet>
        <Header/>
  ...
  <div className='container'>
    <div className='row'>
      <div className='web-container'>
                  ...
                  <span className='colorborder'><em></em></span>
                    <h1 data-aos="fade-down" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">OUR SERVICES</h1>
                  </div>
                  </div>
