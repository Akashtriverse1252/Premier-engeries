  ...
  return (
    <>
      ...
      <div className="App">
            ...
            {isVisible ? <CountUp start={(state.workforce===1) ? 1 : 4} end={4} duration={2} onEnd={()=> setState({ workforce:4 })} /> : <CountUp start={1} end={4} duration={0} />} GW<em>*</em>    
      ...
      <div className="App">
            <div className="countnum">
            {isVisible ? <CountUp start={(state.workforce===1) ? 1 : 5} end={5} duration={2} onEnd={()=> setState({ workforce:5 })} /> : <CountUp start={1} end={5} duration={0} />} GW                
             <div className='labelcont'>
