...
import Leadership01 from './images/srini_pic.webp'
...
export const Sriniadapa = () => {
  return (
    <>
    <Helmet>
    <link rel="canonical" href="https://premierenergies.com/srini-adapa" />
    </Helmet>
                ...
                <div className='web-container'>
                    <div className='leadershipstn'>
                        <div className='leadername'>
                            <h1 data-aos="fade-up" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">SRINI ADAPA</h1>
