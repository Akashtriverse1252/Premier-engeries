...
export const ESG = () => {
  ...
  return (
    ...
    <meta name="description" content="Premier Energies is committed to build a sustainable future through high-quality products and energy-efficient solar solutions." />
    <link rel="canonical" href="https://premierenergies.com/sustainbility" />
    <meta property="og:url" content="https://premierenergies.com/sustainbility" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Commitment to Build Sustainable Future | Premier Energies" />
    <meta name="og:description" content="Premier Energies is committed to build a sustainable future through high-quality products and energy-efficient solar solutions.">
    </meta>
    </Helmet>
        <Header />
  ...
  <div className='container'>
    <div className='row'>
      <div className='web-container'>
                  ...
                  <span className='colorborder'><em></em></span>
                    <h1 data-aos="fade-down" data-aos-offset="100" data-aos-easing="ease-in-sine" data-aos-once='true' data-aos-duration="500">SUSTAINABILITY</h1>
                  </div>
                  </div>
